...
//				System.err.println("{"+catRefKey+"} Does not exists in InfoManager for Locale :: > " + locale);
	...
	private  Row createHeaderRow(int maxLevel, Row headerRow)
	{
		...
		else if(maxLevel==2)
		{
			...
			cell2.setCellValue("LEVEL2_NAME");
			Cell cell3 = headerRow.createCell(3);
			cell3.setCellValue("LEVEL2_REFKEY");
		}
		else if(maxLevel==3)
		{
			Cell cell0 = headerRow.createCell(0);
			...
			cell4.setCellValue("LEVEL3_NAME");
			Cell cell5 = headerRow.createCell(5);
			cell5.setCellValue("LEVEL3_REFKEY");
		}
		else if(maxLevel==4)
		{
			Cell cell0 = headerRow.createCell(0);
			...
			cell6.setCellValue("LEVEL4_NAME");
			Cell cell7 = headerRow.createCell(7);
			cell7.setCellValue("LEVEL4_REFKEY");
		}
		else if(maxLevel==5)
		{
			Cell cell0 = headerRow.createCell(0);
			...
			cell8.setCellValue("LEVEL5_NAME");
			Cell cell9 = headerRow.createCell(9);
			cell9.setCellValue("LEVEL5_REFKEY");
		}
		else if(maxLevel==6)
		{
			Cell cell0 = headerRow.createCell(0);
			...
			cell10.setCellValue("LEVEL6_NAME");
			Cell cell11 = headerRow.createCell(11);
			cell11.setCellValue("LEVEL6_REFKEY");
		}
		else if(maxLevel==7)
		{
			Cell cell0 = headerRow.createCell(0);
			...
			cell12.setCellValue("LEVEL7_NAME");
			Cell cell13 = headerRow.createCell(13);
			cell13.setCellValue("LEVEL7_REFKEY");
		}
		else if(maxLevel==8)
		{
			Cell cell0 = headerRow.createCell(0);
			...
			cell14.setCellValue("LEVEL8_NAME");
			Cell cell15 = headerRow.createCell(15);
			cell15.setCellValue("LEVEL8_REFKEY");
		}
		return headerRow;
	}
}
